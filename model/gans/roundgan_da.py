...
class RoundGAN(BaseGAN):
    ...
    def forward_train(self, img_a, img_b, img_c, meta):
        ...
        fake_b = generators['a'](real_a)
        fake_c = generators['b'](real_b)
        fake_a = generators['c'](real_c)
        rec_a = generators['c'](generators['b'](fake_b))
        rec_b = generators['a'](generators['c'](fake_c))
        rec_c = generators['b'](generators['a'](fake_a))
