...
class CityZurichDataset2(Dataset):
    ...
    def __init__(self,
        ...
        self.day_night_pair_list = day_night_pair_list
        ...
        # load annotations
        self.img_infos = self.load_annotations(self.day_night_pair_list,
                                               self.source_img_dir,
    ...
    def load_annotations(self,
        ...
        with open(day_night_pair_list, 'r') as f:
